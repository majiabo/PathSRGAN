# -*- coding: utf-8 -*-
# @Time    : 2019/5/9 上午10:48
# @Author  : kara
# @Email   : majiabo@hust.edu.cn
# @File    : regis_coarse.py
...
def regis(pairs):
    for pair in pairs:
        ...
        #path_10x = high_path
        try:
            ex1,ey1,dW1,dH1,flag = utilis.fast_regis_coarse(low_path, high_path, [4,10],10000)
        ...
        #path_20x = high_path
        try:
            ex2,ey2,dW2,dH2,flag = utilis.fast_regis_coarse(low_path, high_path, [10,20],16000)
        except Exception as ex:
            print(ex)
        if not flag:
            with open('./wrong_match.txt','a') as f:
